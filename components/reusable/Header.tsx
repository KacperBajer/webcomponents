  ...
  return (
    <div className="w-full bg-white shadow-md">
      <div className="w-full mx-auto max-w-screen-xl px-4 py-2 flex justify-between items-center">
        ...
        <button className="hidden sm:block bg-blue-600 text-sm px-4 py-1.5 rounded-md hover:cursor-pointer duration-300 transition-all ease-in-out hover:bg-blue-700 text-white">
          button
        </button>
        <button
